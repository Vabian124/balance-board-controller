...
| Commit | Summary |
|--------|---------|
| [`a53b292`](https://github.com/Vabian124/balance-board-controller/commit/a53b292) | **WiiBrew protocol** — CONNECTION_PROTOCOL.md, `BalanceBoardProtocol` wake/connect `0x34` + extension id `0x0402` logging |
